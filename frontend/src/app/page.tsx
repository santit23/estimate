    ...
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-16">
            <div className="flex items-center">
              <span className="text-2xl font-bold text-indigo-600">AluEst</span>
            </div>
      ...
      <div className="relative overflow-hidden bg-white">
            ...
            <main className="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
              <div className="sm:text-center lg:text-left">
                <h1 className="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl">
                  <span className="block xl:inline">Professional Estimates for</span>{" "}
                  <span className="block text-indigo-600 xl:inline">Aluminium Vendors</span>
                </h1>
                <p className="mt-3 text-base text-gray-500 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-auto">
                  Create accurate, professional estimates in seconds. Manage your material rates, track projects, and impress your customers with AluEst.
                </p>
        ...
        <div className="lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2 bg-gray-50 flex items-center justify-center">
          ...
          <div className="text-gray-300 text-9xl font-bold opacity-20 select-none">
            SaaS
          </div>
        </div>
      </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="lg:text-center">
            ...
            <p className="mt-2 text-3xl leading-8 font-extrabold tracking-tight text-gray-900 sm:text-4xl">
              Everything you need to manage estimates
            </p>
          </div>
          ...
          <div className="mt-10">
            <dl className="space-y-10 md:space-y-0 md:grid md:grid-cols-2 md:gap-x-8 md:gap-y-10">
              {[
                {
                  name: "Custom Material Rates",
                  description: "Set your own prices for glass, aluminium, and hardware. Your estimates reflect your costs.",
                },
                {
                  name: "Instant Calculations",
                  description: "No more manual math. Enter dimensions and get accurate material requirements instantly.",
                },
                {
                  name: "Project Management",
                  description: "Keep track of all your customer estimates in one dashboard. Never lose a quote again.",
                },
                {
                  name: "Professional Output",
                  description: "Generate clean, professional summaries to share with your clients.",
                },
              ].map((feature) => (
